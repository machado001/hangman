package com.machado001.words.ui.screens.gameScreen
...
import com.machado001.words.ui.components.dialogs.BackToHomeDialog
import com.machado001.words.ui.components.dialogs.GameOverDialog
import com.machado001.words.ui.components.dialogs.TipDialog
...
@Composable
fun GameScreen(
    gameViewModel: GameScreenViewModel = viewModel(factory = GameScreenViewModel.Factory),
    onNavigateUp: () -> Unit,
    onPopBack: () -> Boolean,
...
private fun GameContent(
    ...
    Column(
        ...
        Column {
            ...
            TipAndCountTextRow(tip = category, winCount = winCount)
            KeyboardLayout(
        ...
        LazyRow {
            items(wordChosen!!.length) { letterIndex ->
                ...
                if (currentChar.isWhitespace()) {
                    Spacer(modifier = Modifier.padding(16.sdp))
...
@Composable
fun TipAndCountTextRow(
    modifier: Modifier = Modifier,
    tip: String, winCount: Int
) {
    Row(
        modifier = Modifier
...
private fun LivesLeftRow(
    ...
    val pulsate by infiniteTransition.animateFloat(
        ...
        animationSpec = infiniteRepeatable(
            animation = keyframes {
                durationMillis = 4000
                initialValue at 0 with LinearOutSlowInEasing
                targetValue at 200 with LinearOutSlowInEasing
                initialValue at 400 with LinearOutSlowInEasing
                targetValue at 600 with LinearOutSlowInEasing
                initialValue at 800 with LinearOutSlowInEasing
                initialValue at 4000 with LinearEasing
            },
    ...
    Row(
        ...
        modifier = Modifier
            .heightIn(
                39.sdp,
                41.sdp
            ) //this is necessary because the heart's animation is affecting the other composable elements
            .fillMaxWidth()
    ) {
        repeat(livesCount) {
            Icon(
                ...
                modifier = Modifier
                    ...
                    .defaultMinSize(pulsate.toInt().sdp, pulsate.toInt().sdp)
            )
        }
    }
}
...
private fun KeyboardLayout(
    ...
    LazyVerticalGrid(
        columns = GridCells.Adaptive(30.sdp),
        modifier = Modifier
            .fillMaxWidth(),
    ) {
...
private fun KeyboardKey(
    ...
    TextButton(
        ...
        modifier = Modifier.padding(2.4.dp)
    ) {
        Text(
