...
import com.machado001.words.WordsApplication
import com.machado001.words.data.WordsRepository
import com.machado001.words.util.StringUtil
...
class GameScreenViewModel(
    ...
    fun pickRandomWordAndCategory() {
        ...
        val currentCategory = words.keys.random()
        val currentWord = words[currentCategory]?.random()
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                val container = (this[APPLICATION_KEY] as WordsApplication).container
                GameScreenViewModel(container.wordsRepository)
            }
        }
    }
